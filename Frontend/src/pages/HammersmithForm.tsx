...
const HammersmithForm: React.FC = () => {
  ...
  const handleFieldChange = (i: number, e: React.ChangeEvent<HTMLInputElement>) => {
    if (i == 2) {
      validateProofOfStudy(proofOfStudyFileText, setProofMessage, setProofMessageBackgroundColor);
    }
  }
